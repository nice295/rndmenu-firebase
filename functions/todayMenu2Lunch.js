...
function todayMenu2Lunch(date, callback) {
  if (cache.get("todayMenu2Lunch" + date)) {
    console.log("Data from cache, " + date);
    var html = cache.get("todayMenu2Lunch" + date);

    var $ = cheerio.load(html);
    var returnString = "";
    returnString = "<2식당(DE타워) - 점심> (하하)";
    ...
    request.post(
      ...
      function(error, response, html) {
        ...
        cache.put("todayMenu2Lunch" + date, html, 1 * 60 * 60 * 1000);
...
module.exports = todayMenu2Lunch;
